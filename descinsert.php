...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onclick="window.location.href='descinsert.php'">Insert</button>
...
echo "<form name='selectform' method='GET' action='descinsert.php'>";
...
echo "<INPUT type='submit' name='submit' value='Describe'>";
