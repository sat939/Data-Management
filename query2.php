...
<!-------------------------------------------------------->
<center><u>CUSTOMER WITH THE HIGHEST BILL AMOUNT</u>
...
$string1="select name, billamount from PHARMACY.customer c1 where c1.billamount>ALL";
$string2="(select billamount from PHARMACY.customer where name<>c1.name)";
